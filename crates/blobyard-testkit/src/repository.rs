...
pub use yards::{
    ...
    visibility_event, yard_application_policy, yard_conformance, yard_event,
    yard_fault_conformance, yard_owner_event, yard_policy_event,
};
...
fn repository_conformance_validated(
    ...
    if repository.schema_version()? != 23 {
